...
query = {
    ...
    "from": "0",
    "size": "50",  # Number of results to fetch, adjust based on your needs
...
df.to_csv('berkshire_hathaway_portfolio_filings.csv', index=False)

print("Data successfully saved to 'berkshire_hathaway_portfolio_filings.csv'")